...
my %options_spec_all = (
	...
	'rpmbf-debug' => sub { URPM::setInternalVariable("_rpmbf_debug", 1) },
	'rpmdb-debug' => sub { URPM::setInternalVariable("_rpmdb_debug", 1) },
	'rpmfi-debug' => sub { URPM::setInternalVariable("_rpmfi_debug", 1) },
	'rpmio-debug' => sub { URPM::setInternalVariable("_rpmio_debug", 1) },
	'rpmps-debug' => sub { URPM::setInternalVariable("_rpmps_debug", 1) },
	'rpmgi-debug' => sub { URPM::setInternalVariable("_rpmgi_debug", 1) },
	'rpmte-debug' => sub { URPM::setInternalVariable("_rpmte_debug", 1) },
	'rpmevr-debug' => sub { URPM::setInternalVariable("_rpmevr_debug", 1) },
	'rpmds-debug' => sub { URPM::setInternalVariable("_rpmds_debug", 1) },
	'rpmmi-debug' => sub { URPM::setInternalVariable("_rpmmi_debug", 1) },
	'rpmns-debug' => sub { URPM::setInternalVariable("_rpmns_debug", 1) },
	'rpmts-debug' => sub { URPM::setInternalVariable("_rpmts_debug", 1) },
	'fps-debug' => sub { URPM::setInternalVariable("_fps_debug", 1) },
	'mire-debug' => sub { URPM::setInternalVariable("_mire_debug", 1) },
